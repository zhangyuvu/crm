	...
	<form class="form-horizontal" role="form" id="TranForm" style="position: relative; top: -30px;" method="post" action="workbench/transaction/saveTran.do">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" id="hidden-activitySrc" name="activityId" value="26d880d7b35e4793b799334e95cc9e04">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" value="学姐" id="create-contactsName">
				<input type="hidden" name="contactsId" value="c46eb7bb3cfb4f06a86e1d6edad93540"  id="hidden-contactsName">
			</div>
		</div>
