                ...
                $.ajax({
                    ...
                    success:function (data) {
                        if(data.success){
                            ...
                            html += '<font color="gray">市场活动-</font> <b>${requestScope.activity.name}</b> <small style="color: gray;">'+data.remark.createTime+' 由'+data.remark.createBy+'</small>';
                ...
                $.ajax({
                    ...
                    success:function (data) {
                        ...
                        if(data.success){
                            ...
                            html += '<div style="position: relative; top: -40px; left: 40px;" >';
                            html += '<h5>'+data.remark.noteContent+'</h5>';
                            html += '<font color="gray">市场活动-</font> <b>${requestScope.activity.name}</b> <small style="color: gray;">'+data.remark.editTime+' 由'+data.remark.editBy+'</small>';
                            html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
                            html += '<a class="myHref" href="javascript:void(0);" onclick="editRemark(\''+data.remark.id+'\')"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #FF0000;"></span></a>';
                            html += '&nbsp;&nbsp;&nbsp;&nbsp;';
                            html += '<a class="myHref" href="javascript:void(0);" onclick="deleteRemark(\''+data.remark.id+'\')"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #FF0000;"></span></a>';
		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data , function (index , element) {
					...
					html += '<font color="gray">市场活动-</font> <b>${requestScope.activity.name}</b> <small style="color: gray;">'+(element.editFlag==1?element.editTime:element.createTime)+' 由'+(element.editFlag==1?element.editBy:element.createBy)+'</small>';
					html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
